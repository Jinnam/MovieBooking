...
<title>Mega Box Admin - MemberList</title>
		...
		<div id="sidebar" class="nav-collapse ">
			<ul class="sidebar-menu" id="nav-accordion">
				...
				<li class="sub-menu">
					...
					<ul class="sub">
						<li class="active"><a href="memberList.html">회원 목록</a></li>
					</ul>
				</li>
				<!-- 영화 -->
				<li class="sub-menu">
					...
					<ul class="sub">
						<li><a href="movieInsert.html">영화 등록</a></li>
						<li><a href="adminMovieLlist.html">영화 목록</a></li>
					</ul>
				</li>
				<!-- 인물 -->
				<li class="sub-menu">
					...
					<ul class="sub">
						<li><a href="characterInsert.html">인물정보 등록</a></li>
						<li><a href="characterList.html">인물 목록</a></li>
					</ul>
				</li>
				<!-- 극장 -->
				<li class="sub-menu">
					...
					<ul class="sub">
						<li><a href="screenInsert.html">상영관 등록</a></li>
						<li><a href="screenList.html">상영관 목록</a></li>
					</ul>
				</li>
				<!-- 상영일정 -->
				<li class="sub-menu">
					...
					<ul class="sub">
						<li><a href="screenScheduleInsert.html">상영일정 등록</a></li>
						<li><a href="screenScheduleList.html">상영 목록</a></li>
					</ul>
				</li>
				<!-- 통계 -->
				<li class="sub-menu">
					...
					<ul class="sub">
						<li><a href="#">영화별 예매/매출 </a></li>
						<li><a href="#">지점별 예매/매출 </a></li>
						<li><a href="#">날짜별 예매/매출 </a></li>
					</ul>
				</li>
			</ul>
		</div>
