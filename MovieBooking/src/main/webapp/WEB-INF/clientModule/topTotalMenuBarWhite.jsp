          ...
          <a class="waves-effect col btn s1 white"
           ...
           <span class="waves-effect" style="margin-top:25px ; ">
             <div class="ui mini horizontal divided list">
               ...
               <div class="item">
                 <div class="content">
                   <div class="header" style="font-size:14px ; "><a href="#">필름 소사이어티</a></div>
                 </div>
               </div>

               <div class="item">
                 <div class="content">
                   <div class="header" style="font-size:14px ; "><a href="#">클래식 소사이어티</a></div>
                 </div>
               </div>
           ...
           <span class="waves-effect" style="margin-top:25px ; float:right ;">
             <div class="ui mini horizontal divided list" style="float:right;">
               ...
               <div class="item">
                 <div class="content">
                   <div class="header" style="font-size:14px ; "><a href="#">고객센터</a></div>
                 </div>
               </div>

               <div class="item">
                 <div class="content">
                   <div class="header" style="font-size:14px ; "><a href="#">멤버십</a></div>
                 </div>
               </div>

               <div class="item">
                 <div class="content">
                   <div class="header" style="font-size:14px ;  "><a href="#">VIP</a></div>
                 </div>
               </div>
